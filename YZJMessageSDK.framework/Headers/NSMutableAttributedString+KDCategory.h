...
// 国家区号
+ (NSAttributedString *)countryCodeWithCountyName:(NSString *)countryName countryCode:(NSString *)countryCode;

+ (NSAttributedString *)authCountryCodeWithCountyName:(NSString *)countryName countryCode:(NSString *)countryCode;
@end
