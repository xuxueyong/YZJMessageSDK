...
@property(nonatomic,copy)NSArray <PersonSimpleDataModel*>* contactArray;
@property(nonatomic,strong)NSString * extraInfo; //额外的信息，不一定有

-(NSInteger)count;
-(PersonSimpleDataModel *)personAtIndex:(NSInteger)index;
@end
