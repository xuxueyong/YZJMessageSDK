...
//@property (nonatomic, copy) NSString *primaryContent;   // 主要内容
//@property (nonatomic, copy) NSString *contentUrl;     //内容图表URL
//@property (nonatomic, copy) NSString *extUserId;        // 人员外部ID
